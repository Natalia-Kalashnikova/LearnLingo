...
import { joinArrayWithComma, joinArrayWithSpace } from '../../utils/arrayProcessing.js';
...
const TeachersCard = ({ card, selectedLevel }) => {
    const {
        avatar_url,
        conditions,
        experience,
                                    ...
                                    <div className={css.flexContainer}>
                                        ...
                                        <div className={css.flexReviewContainer}>
                                            ...
                                            <p className={css.teachersReviewRating}>
                                                <img className={css.teachersReviewStar} src={IconStar} alt="IconStar" />{' '}                                                
                                                {reviewer_rating}.0
                                            </p>
                                        </div>
                                    </div>
