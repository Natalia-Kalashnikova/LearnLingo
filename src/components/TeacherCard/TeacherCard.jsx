...
import { addToFavorites, removeFromFavorites } from '../../redux/card/card.reducer.js';
import { showWarningToast } from '../../components/ErrorMessages/errorMessages.js';
import { joinArrayWithComma, joinArrayWithSpace } from './arrayProcessing.js';
import PopUp from "../PopUp/PopUp.jsx";
import BookTrialForm from "../Forms/BookTrialForm.jsx";
import { ReactComponent as IconHeart } from '../../images/icon/heart.svg';
import { ReactComponent as IconActiveHeart } from '../../images/icon/active-heart.svg';
import { ReactComponent as IconBook } from '../../images/icon/book-open.svg';
import { ReactComponent as IconStar } from '../../images/icon/star.svg';
import css from '../../components/TeacherCard/TeacherCard.module.css';
                        ...
                        <div>
                            ...
                            <ul className={css.teachersLevelsList}>
                                {levels.map((level) => (
                                    <li
                                        key={nanoid()}
                                        className={`${css.teachersLevelsItem} ${level === selectedLevel
                                            ? css.activeLevel
                                            : selectedLevel
                                                ? css.inactiveLevel
                                                : ''}`}
